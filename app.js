...
// Initialisation avec le package classique et stable
...
app.post('/api/message', async (req, res) => {
    ...
    try {
        // Utilisation du modèle gemini-pro ou gemini-1.5-flash avec les instructions système
...
app.get('/', (req, res) => {
    res.send("API Mini 2.0 en ligne et opérationnelle !");
});
